            ...
            string User_ID, string product, string chanel)
        {
            ...
            if (!string.IsNullOrEmpty(User_ID))
            {
                ...
                var pointofcustomer = new PointofCustomer()
                {
                    ...
                    point_tong = db.CodeGPs.Where(a => a.Phone == customer.Phone && a.Category == "DRG").Count(),
                    point_doi = db.GiftExchanges.Where(a => a.Phone == customer.Phone && a.Product == "DRG").Count(),
